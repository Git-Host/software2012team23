 ...
 * 
 * Based on a file from the The Android Open Source Project
...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, R.id.home, 0, mActivity.getString(R.string.app_name));
     ...
     * {@link at.tugraz.ist.akm.actionbar.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
     */
...
//                            if (showAsAction == SimpleMenuItem.SHOW_AS_ACTION_ALWAYS ||
//                                    showAsAction == SimpleMenuItem.SHOW_AS_ACTION_IF_ROOM) {
