...
public class JsonAPIRequestHandler extends AbstractHttpRequestHandler implements SmsIOCallback, ContactModifiedCallback
{
	...
	public JsonAPIRequestHandler(final Context context, final XmlNode config, final HttpRequestHandlerRegistry registry)
	{
	...
	private void sendResponse(HttpResponse httpResponse, final JSONObject jsonResponse)
	{
		...
		httpResponse.setHeader(WebServerConfig.HTTP.KEY_CONTENT_TYPE, WebServerConfig.HTTP.VALUE_CONTENT_TYPE_JSON);
	}
	...
	private JSONObject processMethod(String method, JSONArray jsonParams)
	{
		...
		// Object obj = new Object(); // this a place holder for any data
		// retrieved
		// // from the API.
		//
		//
