...
public class TextMessageQueryBuilderTest extends WebSMSToolInstrumentationTestcase {
	...
	public void testSetAddress() {
		...
		assertTrue(queryParameters.uri.equals(SmsContentConstants.Uri.INBOX_URI));
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.ADDRESS + " = ? ") == 0);
	...
	public void testSetId() {
		...
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.ID + " = ? ") == 0);
		String[] queryArgs = queryParameters.like;
	...
	public void testSetPerson() {
		...
		assertTrue(queryParameters.uri.equals(SmsContentConstants.Uri.DRAFT_URI));
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.PERSON + " = ? ") == 0);
		String[] queryArgs = queryParameters.like;
	...
	public void testSetRead() {
		...
		assertTrue(queryParameters.uri.equals(SmsContentConstants.Uri.FAILED_URI));
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.READ + " = ? ") == 0);
		String[] queryArgs = queryParameters.like;
	...
	public void testSetSeen() {
		...
		assertTrue(queryParameters.uri.equals(SmsContentConstants.Uri.QUEUED_URI));
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.SEEN + " = ? ") == 0);
		String[] queryArgs = queryParameters.like;
		assertTrue(queryArgs[0].compareTo("1") == 0);
	}
	...
	public void testSetThreadId() {
		...
		assertTrue(queryParameters.uri.equals(SmsContentConstants.Uri.UNDELIVERED_URI));
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.THREAD_ID + " = ? ") == 0);
		String[] queryArgs = queryParameters.like;
	...
	public void testSetMultipleQueries() {
		...
		logVerbose(queryParameters.where + "|" + SmsContentConstants.Column.ADDRESS + " = ?  AND " +
		...
		assertTrue(queryParameters.where.compareTo(SmsContentConstants.Column.ADDRESS + " = ?  AND " +
				SmsContentConstants.Column.THREAD_ID + " = ?  AND " +
				SmsContentConstants.Column.ID + " = ?  AND " +
				SmsContentConstants.Column.PERSON + " = ?  AND " +
				SmsContentConstants.Column.SEEN + " = ?  AND " +
