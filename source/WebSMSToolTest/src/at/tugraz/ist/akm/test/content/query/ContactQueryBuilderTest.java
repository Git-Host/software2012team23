...
public class ContactQueryBuilderTest extends WebSMSToolInstrumentationTestcase
{
    ...
    public void testSetIsStarredFilter()
    {
        ...
        assertTrue(queryParams.uri
                .equals(ContactsContract.Contacts.CONTENT_URI));
        assertTrue(queryParams.where
                .compareTo(ContactsContract.Contacts.STARRED + " = ? ") == 0);
    ...
    public void testSetHasPhoneNumber()
    {
        ...
        assertTrue(queryParams.uri
                .equals(ContactsContract.Contacts.CONTENT_URI));
        assertTrue(queryParams.where
                .compareTo(ContactsContract.Contacts.HAS_PHONE_NUMBER + " = ? ") == 0);
        String[] queryArgs = queryParams.like;
        assertTrue(queryArgs[0].compareTo("1") == 0);
    }
